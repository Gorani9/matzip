...
class UserRepositoryImplTest {
    ...
    void pagingHasNextTest() {
        // given
        SearchRequest request = new SearchRequest("user", 0, 4, null, false);
    ...
    void pagingTest2() {
        // given
        SearchRequest request = new SearchRequest("user", 0, 5, null, false);
    ...
    void searchingTest() {
        // given
        SearchRequest request = new SearchRequest("01", 0, 5, null, false);
    ...
    void sortingByUsernameTest() {
        // given
        SearchRequest request = new SearchRequest("user", 0, 5, USERNAME, true);
    ...
    void sortingByLevelTest() {
        // given
        SearchRequest request = new SearchRequest("user", 0, 5, MATZIP_LEVEL, true);
    ...
    void sortingByFollowersTest() {
        // given
        SearchRequest request = new SearchRequest("user", 0, 5, NUMBER_OF_FOLLOWERS, true);
    ...
    void sortingByCreatedAtTest() {
        // given
        SearchRequest request = new SearchRequest("user", 0, 5, null, true);
