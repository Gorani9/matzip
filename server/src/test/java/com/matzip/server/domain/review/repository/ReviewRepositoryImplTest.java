...
class ReviewRepositoryImplTest {
    ...
    void pagingHasNextTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 5, null, false);
    ...
    void pagingTest2() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, null, false);
    ...
    void searchingTest() {
        // given
        ReviewSearch request = new ReviewSearch("01", 0, 6, null, false);
    ...
    void sortingByUsernameTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, REVIEWER_USERNAME, true);
    ...
    void sortingByLevelTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, REVIEWER_MATZIP_LEVEL, true);
    ...
    void sortingByFollowersTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, REVIEWER_NUMBER_OF_FOLLOWERS, true);
    ...
    void sortingByHeartsTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, NUMBER_OF_HEARTS, true);
    ...
    void sortingByScrapsTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, NUMBER_OF_SCRAPS, true);
    ...
    void sortingByCommentsTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, NUMBER_OF_COMMENTS, true);
    ...
    void sortingByRatingsTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, RATING, true);
    ...
    void sortingByCreatedAtTest() {
        // given
        ReviewSearch request = new ReviewSearch("review", 0, 6, null, true);
